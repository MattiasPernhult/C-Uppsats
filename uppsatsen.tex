...
% - Kanske lägga till lite koppling till Nunamakers
...
% - direkt återkoppling
% - tillgängligheten
% - verifiera korrektheten
% - Plus i kanten är att quiz kan användas --> förbättrar studenterna

% - ökade krav på uppgifter och testfall
% - bedöma kvalitativa aspekter

% - bedömningssystem bör användas i avancerade kurser med innehåll på algoritmer
% - det kan absolut användas i introduktionskurser speciellt till uppgifter som inte kräver kreativa eller kvalitativa aspekter utan mer verifierar indata och utdata och att programmet är korrekt implementerat
...
% - Vidareutveckla systemet: stöd för plagierings-detection, kunna bedöma kvalitén, ge bättre feedback
% - Enbart fokusera på att förbättra automatiserad feedback, hur ska man ge bästa återkoppling för studenter
% - Undersöka säkerheten grundligt
% - Göra en fallstudie och undersöka effekterna av att använda systemet, minskas lärarnas tid, lär sig studenterna mer, leder det till färre avhopp bland studenterna
