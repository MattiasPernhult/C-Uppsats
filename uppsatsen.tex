...
\subsubsection{Systembeskrivning}
Informationen som införskaffades genom litteraturstudien och intervjuer med lärare låg till grund för LEAP, \textit{LEarning and Assessment of Programming}, vilket är namnet på den prototyp som vi utvecklat. Utifrån den insamlade informationen definierade vi ett antal krav som vi anser att vår prototyp ska uppfylla:
...
\item
Systemet ska kunna hantera kod innehållandes oändliga loopar.
\item
...
Kontrollerade experiment bla bla...
